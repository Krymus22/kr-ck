 ...
 *
 * NOTE: figures v6+ moved all symbols under `.default` instead of exporting
 * them as top-level named exports. We handle both shapes for forward-compat.
 */

import figures from "figures";

// figures v6+ exposes symbols via .default; older versions exported them
// at the top level. Handle both shapes.
const F = (figures as any).default ?? (figures as any);
