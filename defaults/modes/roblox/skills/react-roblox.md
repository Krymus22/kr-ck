...
> **Source:** This skill is the official README from [jsdotlua/react-lua](https://github.com/jsdotlua/react-lua) on GitHub.
> All credit goes to the original authors. Licensed under their respective licenses.
> Fetched on 2026-06-17.

---

> **Note:** `React-Roblox` is one module within the larger [jsdotlua/react-lua](https://github.com/jsdotlua/react-lua) project.
> The README below is the parent project's README. See the dedicated docs page for `React-Roblox`: https://jsdotlua.github.io/react-lua/
